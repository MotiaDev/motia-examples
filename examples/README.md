...
- **[Workflow Patterns](./foundational/workflow-patterns/)** - Long-running workflows, human-in-the-loop (1 example)
...
- **[Specialized Agents](./ai-agents/specialized-agents/)** - ReAct pattern, code review, research, moderation, planning
