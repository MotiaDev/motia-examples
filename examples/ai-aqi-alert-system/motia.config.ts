...
function aqiDashboardPlugin(motia: MotiaPluginContext): MotiaPlugin {
  return {
    dirname: path.join(__dirname, 'plugins/plugin-aqi-dashboard'),
    workbench: [
      {
        packageName: '~/plugins/plugin-aqi-dashboard',
        componentName: 'AQIDashboardUI',
        label: 'AQI Dashboard',
        labelIcon: 'cloud',
        position: 'top',
      },
