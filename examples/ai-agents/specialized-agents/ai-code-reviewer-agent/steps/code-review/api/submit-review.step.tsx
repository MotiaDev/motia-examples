...
/**
 * Custom GitHub-themed UI for the Submit Review API endpoint
 */
    ...
    <ApiNode {...props}>
      <div className="flex flex-col gap-2 p-1">
        <div className="flex items-center gap-2">
          ...
          <div>
            <div className="text-sm font-semibold text-[#f0f6fc]">GitHub Webhook</div>
            <div className="text-xs text-[#8b949e]">POST /reviews/submit</div>
          </div>
        </div>
