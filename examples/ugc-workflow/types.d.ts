...
declare module 'motia' {
  ...
  interface Handlers {
    'ImageKitAuthAPI': ApiRouteHandler<Record<string, unknown>, unknown, never>
    'FileStorageStep': EventHandler<{ requestId: string; variantId: number; videoPath: string; generatedImageUrl: string; variant: { variant_id: number; camera_angle: string; lighting: string; product_info: { brand_name: string; product: string; watermark: string } }; timestamp: string }, never>
    'VideoGenerationStep': EventHandler<{ requestId: string; variantId: number; originalImageUrl: string; generatedImageUrl: string; variant: { variant_id: number; camera_angle: string; lighting: string; headline_seed: string; product_info: { brand_name: string; product: string; watermark: string } }; timestamp: string }, { topic: 'video.generated'; data: { requestId: string; variantId: number; videoPath: string; generatedImageUrl: string; variant: { variant_id: number; camera_angle: string; lighting: string; product_info: { brand_name: string; product: string; watermark: string } }; timestamp: string } }>
